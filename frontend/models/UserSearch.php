...
class UserSearch extends User {
  ...
  public function rules() {
    return [
        ...
        [['username', 'auth_key', 'password_hash', 'password_reset_token', 'oauth_client', 'oauth_client_user_id', 'email', 'first_name', 'last_name', 'student_id', 'faculty', 'branch', 'start_study', 'support_password'], 'safe'],
    ];
  }
