            ...
            <section class="sidebar">
                ...
                <?php echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
                            'label'=>Yii::t('backend', 'Question Save'),
                            'icon'=>'<i class="glyphicon glyphicon-floppy-saved"></i>',
                            'url'=>['/question-save/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'Question Set'),
                            'icon'=>'<i class="glyphicon glyphicon-wrench"></i>',
                            'url'=>['/question-set/index'],
                            'visible'=>Yii::$app->user->can('administrator')
                        ],
                        [
                            'label'=>Yii::t('backend', 'รายงาน'),
                            'url' => '#',
                            'icon'=>'<i class="glyphicon glyphicon-duplicate"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                               
                                ['label'=>Yii::t('backend', 'Question Save'), 'url'=>['/report/question-save'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Subject'), 'url'=>['/report/subject'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
